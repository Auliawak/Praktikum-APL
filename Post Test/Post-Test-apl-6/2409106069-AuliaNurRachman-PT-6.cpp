...
void tampilkanPesanan(Pesanan *pesanan) {
    if (pesanan->jumlahPesanan == 0) {
        ...
        sort(pesanan->daftarParfum, pesanan->daftarParfum + pesanan->jumlahPesanan, [](const Parfum &a, const Parfum &b) {
            if (a.namaParfum == b.namaParfum) {
                return a.harga > b.harga;
            }
            return a.namaParfum < b.namaParfum;
        });
